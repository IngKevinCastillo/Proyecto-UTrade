...
namespace BLL.Servicios
{
    ...
    {
        private readonly IRepositorioGenerico<ChatDTO> _chatRepositorio;
        private readonly IMapper _mapper;

        public ChatServicio(IRepositorioGenerico<ChatDTO> chatRepositorio, IMapper mapper)
        {
        ...
        public async Task<ChatDTO> Crear(ChatDTO modelo)
        {
            try
            {
                var chatCreado = await _chatRepositorio.Crear(_mapper.Map<ChatDTO>(modelo));
